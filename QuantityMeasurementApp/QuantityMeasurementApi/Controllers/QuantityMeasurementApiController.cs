...
namespace QuantityMeasurementApi.Controllers
{
    ...
    public class QuantityMeasurementApiController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(QuantityDTO), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public IActionResult Add([FromBody] QuantityArithmeticInputDTO  input)
        {
        ...
        [ProducesResponseType(typeof(QuantityDTO), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public IActionResult Subtract([FromBody] QuantityArithmeticInputDTO  input)
        {
        ...
        public IActionResult GetByOperation(string operationType)
        {
            ...
            var result = _repository.GetByOperationType(operationType, GetCurrentUserId());
            return Ok(result);
        }
        ...
        public IActionResult GetByMeasurementType(string measurementType)
        {
            ...
            var result = _repository.GetByMeasurementType(measurementType, GetCurrentUserId());
            return Ok(result);
        }
        ...
        public IActionResult GetErrored()
        {
            ...
            var result = _repository.GetErroredMeasurements(GetCurrentUserId());
            return Ok(result);
        }
        ...
        public IActionResult GetCount(string operationType)
        {
            ...
            var count = _repository.GetCountByOperationType(operationType, GetCurrentUserId());
        ...
        public IActionResult GetAll()
        {
            ...
            var result = _repository.GetAll(GetCurrentUserId());
            return Ok(result);
        }
    }
}